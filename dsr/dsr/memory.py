...
class UniquePriorityProgramQueue(UniquePriorityQueue):
    """A UniquePriorityQueue with additional utilities specific to Batch
    and Program."""

    def push(self, sample, program):
        """
